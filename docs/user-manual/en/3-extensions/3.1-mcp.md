...
When enabling an app's toggle, bianma-app will:
...
When disabling an app's toggle, bianma-app will:
...
If you have already configured MCP servers in CLI tools, you can import them into bianma-app:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode)
3. bianma-app reads the existing configuration and imports it
