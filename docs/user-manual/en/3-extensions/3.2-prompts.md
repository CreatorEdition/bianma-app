...
bianma-app provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
bianma://v1/import?resource=prompt&app=claude&name=<name>&content=<base64-encoded content>
```
