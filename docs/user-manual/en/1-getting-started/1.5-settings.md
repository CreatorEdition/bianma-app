...
This path keeps a legacy compatibility identifier and does not represent the current public brand.
...
`cc-switch-sync` is kept as a legacy compatibility directory name so existing remote snapshots continue to work.
