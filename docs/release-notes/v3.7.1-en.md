...
Visit [Releases](https://github.com/CreatorEdition/bianma-app/releases/latest) to download the latest version
...
v3.7.0 represents a shift in bianma-app's positioning:
...
- **Issues**: [GitHub Issues](https://github.com/CreatorEdition/bianma-app/issues)
