...
Added full reverse proxy support for GitHub Copilot, enabling Copilot-authenticated requests to be forwarded through bianma-app.
...
Users enable this feature **at their own risk**. bianma-app is not responsible for any account restrictions, warnings, or service suspensions resulting from the use of this feature.

---

## Download & Installation

> Historical note: The artifact names below and the commands referencing CC Switch reflect how this release was distributed at the time; they are preserved here for archival reference rather than as marketing guidance.
...
| File                                       | Description                                          |
| ------------------------------------------ | ---------------------------------------------------- |
| `CC-Switch-v3.12.3-Windows.msi`            | MSI installer with auto-update                      |
...
| File                               | Description                                                          |
| ---------------------------------- | -------------------------------------------------------------------- |
| `CC-Switch-v3.12.3-macOS.dmg`     | DMG installer; drag to Applications (Universal Binary). |
| `CC-Switch-v3.12.3-macOS.zip`     | ZIP archive; extract and drag to Applications (Universal Binary). |
| `CC-Switch-v3.12.3-macOS.tar.gz`  | Tarball used by Homebrew for installation and auto-update.          |

> macOS builds are code-signed and notarized by Apple for a seamless install experience.

### Homebrew (macOS)

> Historical note: The commands below reference the legacy `cc-switch` Homebrew tap; they remain here for archival purposes.
...
> Historical note: Linux package names above also carried the CC Switch prefix in this archived release.