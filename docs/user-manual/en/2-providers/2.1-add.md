...
One-click import via `bianma://` protocol links. For legacy compatibility details, see the [Migration from CC Switch (ZH)](../../zh/5-faq/5.5-migration-from-cc-switch.md) guide.
