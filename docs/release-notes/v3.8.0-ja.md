...
bianma-app v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/CreatorEdition/bianma-app/releases/latest) から入手:
...
- **Issue**: [GitHub Issues](https://github.com/CreatorEdition/bianma-app/issues)
