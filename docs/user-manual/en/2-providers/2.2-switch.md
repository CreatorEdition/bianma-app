...
2. bianma-app updates the configuration file
...
1. Right-click the bianma-app icon in the system tray
...
When switching providers, bianma-app modifies the following files:
