...
bianma-app v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
Visit [Releases](https://github.com/CreatorEdition/bianma-app/releases/latest) to download:
...
- **Issue Reports**: [GitHub Issues](https://github.com/CreatorEdition/bianma-app/issues)
- **Discussions**: [GitHub Discussions](https://github.com/CreatorEdition/bianma-app/discussions)
