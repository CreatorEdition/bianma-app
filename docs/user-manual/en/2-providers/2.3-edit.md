...
bianma-app provides rich icon customization features:
...
This ensures bianma-app and CLI tool configurations stay in sync.
...
When adding a provider, bianma-app automatically extracts endpoint URLs from the configuration.
