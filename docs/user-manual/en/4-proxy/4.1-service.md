...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (bianma-app)
...
After starting the proxy and enabling app takeover, bianma-app modifies app configurations:
...
When stopping the proxy, bianma-app will:
